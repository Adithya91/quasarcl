...
#np <- import("numpy")
#getwd()
setwd("/home/adithya/Astro")

wavelengthsMatrix

output <- wavelengthsMatrix
...
source_python("parametrization_lib.py")

source_python("Test.py")

result <- oper(wavelengthsMatrix, spectrumsMatrix, continuumsMatrix, feTemplatesMatrix,'*')
